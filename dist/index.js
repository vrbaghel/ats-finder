...
const ATS_PLATFORMS = [
    {
        name: 'Greenhouse',
        getApiUrl: (slug) => `https://boards-api.greenhouse.io/v1/boards/${slug}/jobs`,
        getBoardUrl: (slug) => `https://boards.greenhouse.io/${slug}`,
    },
    {
        name: 'Lever',
        getApiUrl: (slug) => `https://api.lever.co/v0/postings/${slug}`,
        getBoardUrl: (slug) => `https://jobs.lever.co/${slug}`,
    },
    {
        name: 'Ashby',
        getApiUrl: (slug) => `https://api.ashbyhq.com/posting-api/job-board/${slug}`,
        getBoardUrl: (slug) => `https://jobs.ashbyhq.com/${slug}`,
    }
];
/**
 ...
 */
async function findATS(companyName) {
